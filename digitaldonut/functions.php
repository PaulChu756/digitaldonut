...
function candy_customize_register($wp_customize) {
	...
	$wp_customize->add_setting( 'et_divi[footer_copyright_text]', array(
		'default'       => '<a href="www.digitaldonuts.design" target="_blank">Digital Donuts</a> | Powered by <a href="http://www.wordpress.org" target="_blank">WordPress</a> & <a href="http://www.elegantthemes.com/affiliates/idevaffiliate.php?id=17835" target="_blank">Divi</a>',
		'type'			=> 'option',
		'capability'	=> 'edit_theme_options',
		'transport'		=> 'postMessage',
		//'sanitize_callback' => 'wp_validate_boolean',
